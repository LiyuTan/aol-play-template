package com.aol.videonews.ui.swipecard;
...
import com.aol.videonews.ui.swipecard.BaseFlingAdapterView;
import com.aol.videonews.ui.swipecard.FlingCardListener;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private OnActiveCardChangedListener mOnActiveCardChangedListener;
    ...
    */
    private void setTopView() {
        if(getChildCount()>0){
            ...
            View oldActiveCard = mActiveCard;
            ...
            if(mActiveCard!=null) {
                ...
                if (mOnActiveCardChangedListener != null) {
                    mOnActiveCardChangedListener.onActiveCardChanged(mActiveCard, oldActiveCard);
                }
            }
        }
    }
    ...
    public void setOnActiveCardChangedListener(OnActiveCardChangedListener onActiveCardChangedListener) {
        this.mOnActiveCardChangedListener = onActiveCardChangedListener;
    }
    ...
    public interface OnActiveCardChangedListener {
        void onActiveCardChanged(View activeCard, View oldActiveCard);
    }
